...
pub(super) struct McpSnapshotDiffRequest {
    ...
    pub from_ts: String,
    #[schemars(
        description = "Newer snapshot timestamp (millis). Must be strictly greater than from_ts."
    )]
    pub to_ts: String,
    #[schemars(description = "Unified diff context lines around each change (default: 3)")]
